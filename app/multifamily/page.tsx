...
export const metadata = {
  title: "Multifamily Renovations - AI-Powered Solutions | Perfect Building Supply Co.",
  description: "Transform your multifamily properties with Perfect Building Supply Co.'s AI-powered renovation solutions. On spec, on time, on budget.",
};
