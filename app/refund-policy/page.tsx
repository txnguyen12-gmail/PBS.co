    ...
    <>
      ...
      <article className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg max-w-none text-gray-700">
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">1. General Return Policy</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">2. Eligibility for Returns</h2>
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">3. Non-Returnable Items</h2>
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">4. Restocking Fees</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">5. Damaged or Defective Items</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">6. How to Initiate a Return</h2>
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">7. Refund Processing</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">8. Cancellations</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-navy mt-8 mb-4">9. Contact Us</h2>
          <p className="mb-6">
