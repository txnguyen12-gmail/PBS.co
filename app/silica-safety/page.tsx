    ...
    <>
      ...
      <article className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg max-w-none text-gray-700">
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">What is Crystalline Silica?</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">Who Is at Risk?</h2>
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">OSHA Standards</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">Protective Measures</h2>
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">Health Monitoring</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">Our Commitment</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">Resources</h2>
