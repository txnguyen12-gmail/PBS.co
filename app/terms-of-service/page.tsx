    ...
    <>
      ...
      <article className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">2. Account Registration</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">3. Products and Pricing</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">4. Orders and Payment</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">5. Shipping and Delivery</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">6. Returns and Refunds</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">7. Intellectual Property</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">8. Limitation of Liability</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">10. Changes to These Terms</h2>
          <p className="mb-6">
