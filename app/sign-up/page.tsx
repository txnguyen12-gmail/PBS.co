    ...
    return (
      <section className="min-h-[80vh] flex items-center justify-center bg-surface-light">
        <div className="max-w-md mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl font-bold text-navy mb-4">Welcome to Perfect Building Supply Co.!</h1>
    ...
    <section className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          <h2 className="text-2xl lg:hidden font-bold text-navy mb-2">Join Perfect Building Supply Co.</h2>
