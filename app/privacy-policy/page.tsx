    ...
    <>
      ...
      <article className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">3. Information Sharing</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">4. Data Security</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">5. Cookies and Tracking</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">6. Your Rights</h2>
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">7. Third-Party Links</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">8. Children&apos;s Privacy</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">9. Changes to This Policy</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-charcoal mt-8 mb-4">10. Contact Us</h2>
          <p className="mb-6">
