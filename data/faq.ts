...
export const surfacesFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "TanClub is our loyalty program offering cashback on orders, exclusive discounts, and personalized support to help improve your margins on every project.",
  },
  {
    question: "How does TanCash work?",
    answer: "You earn TanCash on every fulfilled order. Your balance is redeemable for future savings on upcoming purchases.",
  },
  {
    question: "What is your shipping coverage and delivery like?",
    answer: "We ship nationwide using local routing from the nearest partner warehouse, ensuring faster and more reliable delivery.",
  },
  {
    question: "Why are your prices so low?",
    answer: "We partner directly with vendors and distributors, eliminating middleman markups and passing the savings on to you.",
  },
  {
    question: "Do you sell to homeowners?",
    answer: "Yes, but stone slabs must be received through a certified fabricator. Our expert team can provide referrals to help connect you with one.",
  },
];
